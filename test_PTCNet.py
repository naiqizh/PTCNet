...
parser = argparse.ArgumentParser(description='PTCNet BRATS 2021/2023 Training')
...
parser.add_argument('--cfg', type=str, default="PTCNet/configs/ptcnet_base.yaml", metavar="FILE",
...
def main(args):
    ...
    args.exp_name = "saved_model_2023_valid_ptcnet_5_31"
    args.save_folder_1 = pathlib.Path(f"./PTCNet/test/{args.exp_name}")
    print("args.save_folder_1:", args.save_folder_1)
    ...
    args.checkpoint = args.save_folder_1 / "model_final.pth.tar"
    ...
    bench_loader = torch.utils.data.DataLoader(bench_dataset, batch_size=args.batch_size, num_workers=args.workers, pin_memory=True)
